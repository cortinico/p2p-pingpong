 ...
 *
 */
public class PongCacheBootstrapPeer extends PongCachePeer {
	...
	/**
	 * Costruttore per generare un nuovo peer di tipo PongCacheBootstrapPeer
	 * 
	 * @param ip Indirizzo del nuovo peer
	 */
	public PongCacheBootstrapPeer(String ip) { super(ip); }
	
	/**
	 * Costruttore per generare un nuovo peer di tipo PongCacheBootstrapPeer e connetterlo ad un altro
	 * peer gia' esistente
	 * 
	 * @param ip Indirizzo del nuovo peer
	 * @param first Peer esistente a cui connettersi
	 */
	public PongCacheBootstrapPeer(String ip, Peer first) { super(ip, first); }
